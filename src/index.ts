...
export interface ContentDispositionCreateOptions {
  /**
...
export interface ContentDispositionFormat {
  type: string;
 ...
 */
export function format(obj: ContentDispositionFormat): string {
 ...
 */
class ContentDispositionImpl implements ContentDisposition {
  type: string;
  parameters: Record<string, string>;
